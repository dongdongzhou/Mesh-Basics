...
public class RoundedCube : MonoBehaviour
{
   ...
   //     gameObject.AddComponent<Rigidbody>();
    ...
    {
        AddBoxColliders(xSize, ySize-roundness*2, zSize-roundness*2);
        AddBoxColliders(xSize - roundness * 2, ySize, zSize - roundness * 2);
        AddBoxColliders(xSize-roundness*2, ySize-roundness*2, zSize);
    ...
    void AddBoxColliders(float x, float y, float z)
    {
